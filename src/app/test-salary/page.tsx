      ...
      <div className="px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          ...
          <div className="bg-gradient-to-r from-green-600 to-green-700 -mx-4 sm:-mx-6 lg:-mx-8 px-4 sm:px-6 lg:px-8 py-8 rounded-lg mb-8">
            <div className="flex items-center">
              ...
              <div>
                <h1 className="text-3xl font-bold text-white">給与計算システム (テスト)</h1>
                <p className="text-green-100 mt-2 text-lg">
                  従業員の勤務時間と給与を管理・計算します（認証なしテスト）
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="mt-8 bg-blue-50 p-4 rounded-lg">
          <p className="text-sm text-blue-800">
            ✅ <strong>給与計算システム テストページ</strong>
          </p>
          <p className="text-xs text-blue-600 mt-1">
            認証をバイパスしたテストページが正常に動作しています。
          </p>
          <p className="text-xs text-gray-600 mt-2">
            ⚠️ これは診断用のテストページです。実際の給与計算ページは <code>/admin/salary</code> です。
          </p>
        </div>
      </div>
    </div>
